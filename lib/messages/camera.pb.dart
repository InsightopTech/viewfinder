...
class Camera extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Camera', package: const $pb.PackageName(_omitMessageNames ? '' : 'camera'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'displayName', $pb.PbFieldType.O3)
  ...
  @$pb.TagNumber(2)
  $core.int get displayName => $_getIZ(1);
  @$pb.TagNumber(2)
  set displayName($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
